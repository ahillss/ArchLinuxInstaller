...
function setup_i3blocks() {
	...
	echo -e '\n[memory_free]\ncommand=awk '"'"'/MemAvailable/ {printf("%d\\xd0\\xbc\\xd0\\xb2\\n", ($2/1000))}'"'"' /proc/meminfo\ninterval=2' >> $HOME/.config/i3blocks/config
	echo -e '\n#[memory_used]\n#color=#EE6688\n#command=awk '"'"'/MemTotal|MemAvailable/ {print $2}'"'"' /proc/meminfo | paste -sd'"'"' '"'"' | awk '"'"'{printf "%d\\xd0\\xbc\\xd0\\xb2\\n",($1-$2)/1000}'"'"'\n#interval=2' >> $HOME/.config/i3blocks/config
	echo -e '\n#[swap_free]\n#color=#FFEECC\n#command=awk '"'"'/SwapFree/ {printf("%d\\xd0\\xbc\\xd0\\xb2\\n", ($2/1000))}'"'"' /proc/meminfo\n#interval=2' >> $HOME/.config/i3blocks/config
	echo -e '\n#[swap_used]\n#color=#EE6688\n#command=awk '"'"'/SwapTotal|SwapFree/ {print $2}'"'"' /proc/meminfo | paste -sd'"'"' '"'"' | awk '"'"'{printf "%d\\xd0\\xbc\\xd0\\xb2\\n",($1-$2)/1000}'"'"'\n#interval=2' >> $HOME/.config/i3blocks/config
